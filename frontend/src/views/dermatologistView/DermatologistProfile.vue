    ...
    <div id="dermatologistProfile">
        ...
        <div class="homepage_style "  >
            <span style="float: left; margin: 15px;">
                ...
                <button class = "btn btn-info btn-lg space_style" v-on:click = "showExaminations">Examination</button>
                <button class = "btn btn-info btn-lg space_style" v-on:click = "scheduleExamination">Schedule new examination</button>
            </span>
                ...
                <div class=" d-inline-block " style=" height:100%; background-color: #ced2d3;">
                    <div class="p-3 py-5 align-items-center">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4 class="text-right" style="color: #ced2d3; height: 18px"> <b>{{dermatologist.name}} {{dermatologist.surname}}</b></h4>
                        </div>
                        <div class="row mt-2">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6"><label class="labels">City</label><input type="text" class="form-control">{{dermatologist.address}}</div>
